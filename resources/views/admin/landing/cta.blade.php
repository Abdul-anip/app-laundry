...
@section('title', 'Edit CTA Section - LaundryKu')
...
<style>
    ...
    @media (max-width: 768px) { .landing-container { padding: 2rem 1rem; } .landing-card { padding: 2.5rem 2rem; } .page-title { font-size: 1875rem; } }
</style>
@endpush
...
<div class="landing-container">
    <div class="landing-card">
        <h1 class="page-title">Edit CTA Section</h1>
        <p class="page-subtitle">Update judul, text, dan tombol pada bagian Call-to-Action</p>
        ...
        <form action="{{ route('admin.landing.cta.update') }}" method="POST">
            @csrf
            @method('PUT')
