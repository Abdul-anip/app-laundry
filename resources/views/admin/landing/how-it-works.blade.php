...
@section('title', 'Edit How It Works - LaundryKu')
...
<div class="landing-container">
    <div class="landing-card">
        <h1 class="page-title">Edit How It Works</h1>
        <p class="page-subtitle">Update judul dan subtitle pada bagian Cara Kerja</p>
        ...
        <form action="{{ route('admin.landing.how-it-works.update') }}" method="POST">
            @csrf
            @method('PUT')
