...
@section('title', 'Edit Why Choose Us - LaundryKu')
...
<div class="landing-container">
    <div class="landing-card">
        <h1 class="page-title">Edit Why Choose Us</h1>
        <p class="page-subtitle">Update judul dan subtitle pada bagian Kenapa Pilih Kami</p>
        ...
        <form action="{{ route('admin.landing.why-choose.update') }}" method="POST">
            @csrf
            @method('PUT')
